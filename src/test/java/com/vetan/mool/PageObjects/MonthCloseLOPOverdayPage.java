...
public class MonthCloseLOPOverdayPage {

    WebDriver ldriver;

    public MonthCloseLOPOverdayPage(WebDriver rdriver)
    {
        ldriver = rdriver;
	...
	@FindBy(xpath = "(//span[normalize-space()='Loss Of Pay & Overday'])[1]")
	@CacheLookup
	WebElement btnLOPOverday;

	public void clickbtnLOPOverday()
	{
		btnLOPOverday.click();
	}
	...
	@FindBy(xpath = "(//input[@value='lop'])[1]")
	@CacheLookup
	WebElement btnCheckBoxLOP;

	public void clickbtnCheckBoxLOP()
	{
		btnCheckBoxLOP.click();
	}

    @FindBy(xpath = "(//input[@value='overtime'])[1]")
	@CacheLookup
	WebElement btnCheckBoxOverday;

	public void clickbtnCheckBoxOverday()
	{
		btnCheckBoxOverday.click();
	}

    @FindBy(xpath = "(//input[@value='NaN'])[1]")
    @CacheLookup
    WebElement txtNoOfDays;

    public void settxtNoOfDays(String nDays)
    {
        txtNoOfDays.sendKeys(nDays);
    }
